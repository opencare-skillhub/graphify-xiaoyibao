...
def _community_article(
    ...
    lines += ["---", "", "*Part of the xyb knowledge wiki. See [[index]] to navigate.*"]
    return "\n".join(lines)
...
def _index_md(
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated by xyb. Start here — read community articles for context, then drill into god nodes for detail.",
        "",
    ...
    lines += [
        "---",
        "",
        "*Generated by [xyb](https://github.com/safishamsi/xyb)*",
    ]
    return "\n".join(lines)
